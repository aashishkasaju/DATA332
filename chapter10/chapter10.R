...
# Create a logical test that can identify each case to vectorize change_symbols
vec[vec == "DD"]
...
# A vectorized version of change_symbols that runs about 14 times faster
